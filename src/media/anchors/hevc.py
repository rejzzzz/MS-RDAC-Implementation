...
class HEVC:
    ...
    '''
    def __init__(self,seq_name='0',bits=8, qp = 50,fps=30,frame_dim=(256,256),gop_size=10, config='media/anchors/hevc_hm/config_template.cfg', sequence = None):
        self.qp = qp
        self.fps = fps
        self.bits= bits
    ...
    def run(self):
        cmd = ["media/anchors/hevc_hm/hm_16_15_regular/bin/TAppEncoderStatic", "-c", self.config_out_path,"-i", self.in_yuv_path]
        ...
        dec_cmd = ["media/anchors/hevc_hm/hm_16_15_regular/bin/TAppDecoderStatic", "-b", self.ostream_path,'-o',self.dec_yuv_path]
